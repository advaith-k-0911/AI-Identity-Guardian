                ...
                <div className="flex items-center justify-center gap-3 pt-2">
                  {dev.linkedin ? (
                    <a
                      ...
                      className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-black dark:bg-zinc-900 border border-amber-500/60 text-amber-400 hover:border-amber-400 hover:bg-amber-500/10 transition-all font-semibold text-sm"
                    >
