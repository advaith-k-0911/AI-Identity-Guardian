        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 min-w-0">
            <ScrollReveal direction="right" delay={0.2}>
              <Card variant="glow" glowColor="emerald" className="w-full">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-2 flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded bg-green-500/10 text-green-700 dark:text-green-300 border border-green-500/30 flex-shrink-0">
                          {pillar.badge}
                        </span>
                      </div>
